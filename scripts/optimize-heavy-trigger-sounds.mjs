...
const SOURCE_KEYS = [
  'Saved sounds/pirate-tavern-croud.mp3',
  'Saved sounds/footsteps_water.mp3',
  'Saved sounds/heart_beat.mp3',
  'Saved sounds/waves-sea-shore.mp3',
  'Saved sounds/ES_River, Small, Distant Waterfall 02 - Epidemic Sound.mp3',
  'Saved sounds/modern_crowd_cheering.mp3',
  'Saved sounds/fireplace.mp3',
  'Saved sounds/footsteps_wood_stairs.mp3',
  'Saved sounds/ES_Medieval Battlefield, Medium Group, Sword Impacts, Screams, Grunts - Epidemic Sound.mp3',
  'Saved sounds/wind_howl.mp3',
  'Saved sounds/ES_Giant Creature, Roaring - Epidemic Sound.mp3',
  'Saved sounds/phone-ring.mp3',
  'Saved sounds/ES_Wood, 50\'s Gallery Open, Shut - Epidemic Sound.mp3',
  'Saved sounds/rain-on-windows-interior.mp3',
  'Saved sounds/ES_Wohoo, Yay, 7 People 02 - Epidemic Sound.mp3',
  'Saved sounds/ES_Walk On Gravel - Epidemic Sound.mp3',
  'Saved sounds/freesound_community-quick-lightning-strike-29683.mp3',
  'Saved sounds/heart-beep-monitor_dieing-long-beep.mp3',
  'Saved sounds/wind-chimes.mp3',
  'Saved sounds/ES_Hardwood, Female, Heels, Walk 03 - Epidemic Sound.mp3',
  'Saved sounds/bird_whistling_chirping.mp3',
  'Saved sounds/ES_Tiger, Growls, Roars, Several, Intimidated - Epidemic Sound.mp3',
  'Saved sounds/ES_Flames, Large, Movement 01 - Epidemic Sound.mp3',
  'Saved sounds/radio-static.mp3',
  'Saved sounds/dragon-studio-water-dripping-364450.mp3',
];

const TARGET_PREFIX = 'Saved sounds/instant/';
