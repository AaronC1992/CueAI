...
export const SFX_EVENT_EVIDENCE = /\b(knocks?|slams?|creaks?|squeaks?|scrapes?|drags?|pull(?:s|ed|ing)?|unfold(?:s|ed|ing)?|unfurl(?:s|ed|ing)?|tears?|shatter(?:s|ed|ing)?|smash(?:es|ed|ing)?|crash(?:es|ed|ing)?|thuds?|thumps?|bangs?|booms?|explod(?:e|es|ed|ing)|thunder|lightning|rain|storm|wind|howls?|barks?|chirps?|caws?|hoots?|growls?|roars?|screams?|shrieks?|laughs?|whispers?|footsteps?|walk(?:s|ed|ing)?|runs?|ran|running|gallop(?:s|ed|ing)?|hooves?|sword|blade|slashes?|stabs?|clashes?|parr(?:y|ies|ied)|blocks?|punch(?:es|ed|ing)?|hits?|arrow|bow|gunshot|gun|shot|fire|flames?|spell|magic|casts?|bell|rings?|chimes?|drips?|splashes?|waves?|crowd|cheers?|applause|dice|potion|trap)\b/i;
