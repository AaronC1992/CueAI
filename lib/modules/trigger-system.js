...
export function buildTriggerMap(savedSounds) {
    ...
    add('whimper', 'dog whimper', 'Saved sounds/instant/ES_Golden Retriever, Barks, Whimper - Epidemic Sound-instant.mp3', 0.5, 'animal');
    ...
    // Birds
    add('bird', 'bird chirp', 'Saved sounds/instant/bird_whistling_chirping-instant.mp3', 0.5, 'animal');
    add('chirp', 'bird chirp', 'Saved sounds/instant/bird_whistling_chirping-instant.mp3', 0.5, 'animal');
    add('chirping', 'bird chirp', 'Saved sounds/instant/bird_whistling_chirping-instant.mp3', 0.5, 'animal');
    add('tweet', 'bird chirp', 'Saved sounds/instant/bird_whistling_chirping-instant.mp3', 0.5, 'animal');
    ...
    add('trot', 'horse trot', 'Saved sounds/instant/trotting-horse-in-rural-road-instant.mp3', 0.6, 'animal');
    add('trotting', 'horse trot', 'Saved sounds/instant/trotting-horse-in-rural-road-instant.mp3', 0.6, 'animal');
    ...
    add('cavalry', 'cavalry gallop', 'Saved sounds/instant/horses_army_calvery_galloping-Jennas-Laptop-instant.mp3', 0.8, 'animal');
    add('charging', 'cavalry gallop', 'Saved sounds/instant/horses_army_calvery_galloping-Jennas-Laptop-instant.mp3', 0.8, 'animal');
    add('charged', 'cavalry gallop', 'Saved sounds/instant/horses_army_calvery_galloping-Jennas-Laptop-instant.mp3', 0.7, 'animal');
    // Big cats / exotic
    add('lion', 'lion roar', 'Saved sounds/ES_Lion Roar LIke, Gugrling - Epidemic Sound.mp3', 0.8, 'animal');
    add('tiger', 'tiger growl', 'Saved sounds/instant/ES_Tiger, Growls, Roars, Several, Intimidated - Epidemic Sound-instant.mp3', 0.8, 'animal');
    ...
    add('creature', 'creature roar', 'Saved sounds/instant/ES_Giant Creature, Roaring - Epidemic Sound-instant.mp3', 0.8, 'creature');
    ...
    add('ghost', 'ghost eerie', 'Saved sounds/instant/ES_Something in the Basement - Lennon Hutton-instant.mp3', 0.6, 'creature');
    ...
    // ===== COMBAT & WEAPONS =====
    add('sword', 'sword clash', 'Saved sounds/instant/swords-fighting-instant.mp3', 0.8, 'combat');
    add('swords', 'swords fighting', 'Saved sounds/instant/swords-fighting-instant.mp3', 0.8, 'combat');
    ...
    add('clash', 'swords clash', 'Saved sounds/instant/swords-fighting-instant.mp3', 0.8, 'combat');
    add('duel', 'sword fight', 'Saved sounds/instant/ES_Sword Fight, 1v1, Longsword, Medieval Warriors, Knights, In Armor, Schoeps (MS) - Epidemic Sound-instant.mp3', 0.8, 'combat');
    add('fight', 'sword fight', 'Saved sounds/instant/ES_Sword Fight, 1v1, Longsword, Medieval Warriors, Knights, In Armor, Schoeps (MS) - Epidemic Sound-instant.mp3', 0.7, 'combat');
    add('battle', 'battle', 'Saved sounds/instant/ES_Medieval Battlefield, Medium Group, Sword Impacts, Screams, Grunts - Epidemic Sound-instant.mp3', 0.8, 'combat');
    add('war', 'medieval war', 'Saved sounds/instant/ES_Medieval, War, Battle, Armors, Shields, Arrows, Swords Layer - Epidemic Sound-instant.mp3', 0.8, 'combat');
    add('army', 'medieval battle', 'Saved sounds/instant/ES_Medieval, War, Battle, Many Swords, Layer - Epidemic Sound-instant.mp3', 0.8, 'combat');
    // Ranged
    ...
    // Impacts
    add('struck', 'sword clash', 'Saved sounds/instant/swords-fighting-instant.mp3', 0.7, 'combat');
    ...
    // ===== WEATHER =====
    add('thunder', 'thunder storm', 'Saved sounds/instant/thunder_storm-instant.mp3', 0.8, 'weather');
    add('thunderstorm', 'thunder storm', 'Saved sounds/instant/thunder_storm-instant.mp3', 0.8, 'weather');
    add('lightning', 'lightning strike', 'Saved sounds/instant/freesound_community-quick-lightning-strike-29683-instant.mp3', 0.8, 'weather');
    add('rain', 'rain', 'Saved sounds/instant/light_rain_shower-instant.mp3', 0.5, 'weather');
    add('raining', 'rain', 'Saved sounds/instant/rain-on-windows-interior-instant.mp3', 0.5, 'weather');
    add('drizzle', 'light rain', 'Saved sounds/instant/light_rain_shower-instant.mp3', 0.4, 'weather');
    add('storm', 'thunder storm', 'Saved sounds/instant/thunder_storm-instant.mp3', 0.7, 'weather');
    add('wind', 'wind', 'Saved sounds/instant/wind_windy-instant.mp3', 0.5, 'weather');
    add('windy', 'wind', 'Saved sounds/instant/wind_windy-instant.mp3', 0.5, 'weather');
    add('breeze', 'wind', 'Saved sounds/instant/wind_windy-instant.mp3', 0.4, 'weather');
    add('gust', 'wind howl', 'Saved sounds/instant/wind_howl-instant.mp3', 0.6, 'weather');
    add('blizzard', 'wind howl', 'Saved sounds/instant/wind_howl-instant.mp3', 0.7, 'weather');
    ...
    add('flames', 'large fire', 'Saved sounds/instant/ES_Flames, Large, Movement 01 - Epidemic Sound-instant.mp3', 0.7, 'fire');
    ...
    add('torch', 'fire', 'Saved sounds/instant/fireplace-instant.mp3', 0.5, 'fire');
    add('fireworks', 'fireworks', 'Saved sounds/instant/fireworks_display-instant.mp3', 0.7, 'fire');

    // ===== WATER =====
    add('splash', 'water splash', 'Saved sounds/instant/footsteps_water-instant.mp3', 0.6, 'water');
    add('water', 'water flowing', 'Saved sounds/instant/ES_Water Flowing, Small Stream 01 - Epidemic Sound-instant.mp3', 0.4, 'water');
    add('stream', 'stream water', 'Saved sounds/instant/stream-water-instant.mp3', 0.4, 'water');
    add('river', 'river flowing', 'Saved sounds/instant/ES_River, Small, Distant Waterfall 02 - Epidemic Sound-instant.mp3', 0.4, 'water');
    add('waterfall', 'waterfall', 'Saved sounds/instant/ES_River, Small, Distant Waterfall 02 - Epidemic Sound-instant.mp3', 0.5, 'water');
    add('waves', 'waves shore', 'Saved sounds/instant/waves-sea-shore-instant.mp3', 0.5, 'water');
    add('ocean', 'waves shore', 'Saved sounds/instant/waves-sea-shore-instant.mp3', 0.5, 'water');
    add('sea', 'waves shore', 'Saved sounds/instant/waves-sea-shore-instant.mp3', 0.5, 'water');
    add('drip', 'water drip', 'Saved sounds/instant/dragon-studio-water-dripping-364450-instant.mp3', 0.5, 'water');

    // ===== FOOTSTEPS & MOVEMENT =====
    add('footstep', 'footsteps', 'Saved sounds/instant/footsteps_daytime_hike-instant.mp3', 0.6, 'movement');
    add('footsteps', 'footsteps', 'Saved sounds/instant/footsteps_daytime_hike-instant.mp3', 0.6, 'movement');
    add('walking', 'footsteps', 'Saved sounds/ES_Hardwood, Boots, Walking By 02 - Epidemic Sound.mp3', 0.5, 'movement');
    add('walked', 'footsteps', 'Saved sounds/instant/footsteps_daytime_hike-instant.mp3', 0.5, 'movement');
    add('steps', 'footsteps', 'Saved sounds/instant/footsteps_daytime_hike-instant.mp3', 0.5, 'movement');
    ...
    add('heels', 'heels walking', 'Saved sounds/instant/ES_Hardwood, Female, Heels, Walk 03 - Epidemic Sound-instant.mp3', 0.5, 'movement');
    add('boots', 'boots walking', 'Saved sounds/ES_Hardwood, Boots, Walking By 02 - Epidemic Sound.mp3', 0.5, 'movement');
    add('stairs', 'footsteps stairs', 'Saved sounds/instant/footsteps_wood_stairs-instant.mp3', 0.5, 'movement');
    add('gravel', 'footsteps gravel', 'Saved sounds/instant/ES_Walk On Gravel - Epidemic Sound-instant.mp3', 0.5, 'movement');
    add('leaves', 'footsteps leaves', 'Saved sounds/instant/footsteps_leaves-instant.mp3', 0.5, 'movement');
    ...
    add('door', 'door creak', 'Saved sounds/instant/ES_Wood, 50\'s Gallery Open, Shut - Epidemic Sound-instant.mp3', 0.6, 'door');
    add('creak', 'door creak', 'Saved sounds/instant/ES_Wood, 50\'s Gallery Open, Shut - Epidemic Sound-instant.mp3', 0.6, 'door');
    add('creaking', 'door creak', 'Saved sounds/instant/ES_Wood, 50\'s Gallery Open, Shut - Epidemic Sound-instant.mp3', 0.6, 'door');
    add('gate', 'door creak', 'Saved sounds/instant/ES_Wood, 50\'s Gallery Open, Shut - Epidemic Sound-instant.mp3', 0.6, 'door');
    // Bell
    ...
    add('baby', 'baby crying', 'Saved sounds/instant/ES_Newborn, Maternity Ward, Baby Crying - Epidemic Sound-instant.mp3', 0.6, 'human');
    add('crying', 'baby crying', 'Saved sounds/instant/ES_Newborn, Maternity Ward, Baby Crying - Epidemic Sound-instant.mp3', 0.6, 'human');
    add('cry', 'baby crying', 'Saved sounds/instant/ES_Newborn, Maternity Ward, Baby Crying - Epidemic Sound-instant.mp3', 0.5, 'human');
    ...
    add('heartbeat', 'heartbeat', 'Saved sounds/instant/heart_beat-instant.mp3', 0.6, 'human');
    add('heart', 'heartbeat', 'Saved sounds/instant/heart_beat-instant.mp3', 0.5, 'human');
    add('whisper', 'whisper breath', 'Saved sounds/instant/ES_Static Breath - Lennon Hutton-instant.mp3', 0.5, 'human');
    ...
    // ===== CROWDS & CELEBRATIONS =====
    add('applause', 'applause', 'Saved sounds/instant/modern_crowd_cheering-instant.mp3', 0.7, 'crowd');
    add('clap', 'applause', 'Saved sounds/instant/modern_crowd_cheering-instant.mp3', 0.7, 'crowd');
    add('clapping', 'applause', 'Saved sounds/instant/modern_crowd_cheering-instant.mp3', 0.7, 'crowd');
    add('cheer', 'crowd cheering', 'Saved sounds/instant/modern_crowd_cheering-instant.mp3', 0.7, 'crowd');
    add('cheering', 'crowd cheering', 'Saved sounds/instant/modern_crowd_cheering-instant.mp3', 0.7, 'crowd');
    add('hooray', 'crowd cheering', 'Saved sounds/instant/ES_Wohoo, Yay, 7 People 02 - Epidemic Sound-instant.mp3', 0.7, 'crowd');
    add('yay', 'crowd yay', 'Saved sounds/instant/ES_Wohoo, Yay, 7 People 02 - Epidemic Sound-instant.mp3', 0.7, 'crowd');
    add('crowd', 'crowd', 'Saved sounds/instant/ES_Concert Crowd, Stadium, Large, Interior, Long Swell, Call To Encore, The Forum Stadium, Applause - Epidemic Sound-instant.mp3', 0.6, 'crowd');
    add('audience', 'crowd', 'Saved sounds/instant/ES_Concert Crowd, Stadium, Large, Interior, Long Swell, Call To Encore, The Forum Stadium, Applause - Epidemic Sound-instant.mp3', 0.6, 'crowd');
    add('stadium', 'crowd stadium', 'Saved sounds/instant/ES_Concert Crowd, Stadium, Large, Interior, Long Swell, Call To Encore, The Forum Stadium, Applause - Epidemic Sound-instant.mp3', 0.7, 'crowd');
    add('concert', 'concert', 'Saved sounds/instant/ES_Concert, Girls, Teenagers, Squealing, Artist Enters, Bell Centre, Montreal, Canada - Epidemic Sound-instant.mp3', 0.6, 'crowd');
    add('children', 'children', 'Saved sounds/instant/ES_Suburban Kids - Marc Torch-instant.mp3', 0.5, 'crowd');
    add('kids', 'kids', 'Saved sounds/instant/ES_Suburban Kids - Marc Torch-instant.mp3', 0.5, 'crowd');
    ...
    add('phone', 'phone ring', 'Saved sounds/instant/phone-ring-instant.mp3', 0.6, 'misc');
    add('ringing', 'phone ring', 'Saved sounds/instant/phone-ring-instant.mp3', 0.6, 'misc');
    add('telephone', 'phone ring', 'Saved sounds/instant/phone-ring-instant.mp3', 0.6, 'misc');
    ...
    add('static', 'radio static', 'Saved sounds/instant/radio-static-instant.mp3', 0.5, 'misc');
    add('radio', 'radio static', 'Saved sounds/instant/radio-static-instant.mp3', 0.5, 'misc');
    add('rewind', 'tape rewind', 'Saved sounds/rewind.mp3', 0.5, 'misc');
    add('flatline', 'heart monitor', 'Saved sounds/instant/heart-beep-monitor_dieing-long-beep-instant.mp3', 0.6, 'misc');
    add('monitor', 'heart monitor', 'Saved sounds/instant/heart-beep-monitor_dieing-long-beep-instant.mp3', 0.5, 'misc');
    add('hospital', 'heart monitor', 'Saved sounds/instant/heart-beep-monitor_dieing-long-beep-instant.mp3', 0.5, 'misc');

    // ===== NATURE & AMBIENCE =====
    add('cricket', 'crickets', 'Saved sounds/instant/ES_Campfire, Night, Wood Burning Medium, Crickets In Background - Epidemic Sound-instant.mp3', 0.4, 'nature');
    add('crickets', 'crickets', 'Saved sounds/instant/ES_Campfire, Night, Wood Burning Medium, Crickets In Background - Epidemic Sound-instant.mp3', 0.4, 'nature');
    add('chimes', 'wind chimes', 'Saved sounds/instant/wind-chimes-instant.mp3', 0.4, 'nature');
    ...
    add('basement', 'something basement', 'Saved sounds/instant/ES_Something in the Basement - Lennon Hutton-instant.mp3', 0.6, 'horror');
    add('cellar', 'something basement', 'Saved sounds/instant/ES_Something in the Basement - Lennon Hutton-instant.mp3', 0.6, 'horror');
    add('sewer', 'sewer', 'Saved sounds/instant/ES_Trapped in the Sewers - Experia-instant.mp3', 0.6, 'horror');
    add('sewers', 'sewer', 'Saved sounds/instant/ES_Trapped in the Sewers - Experia-instant.mp3', 0.6, 'horror');
    ...
    add('scuba', 'scuba breathing', 'Saved sounds/instant/ES_Scuba Mask, Breathing, Oxygen Tank - Epidemic Sound-instant.mp3', 0.5, 'horror');
    ...
    add('boo', 'ghost whisper', 'Saved sounds/instant/ES_Static Breath - Lennon Hutton-instant.mp3', 0.5, 'halloween');
    add('spooky', 'eerie', 'Saved sounds/instant/ES_Something in the Basement - Lennon Hutton-instant.mp3', 0.5, 'halloween');
    ...
    // ===== D&D FLAVOR =====
    add('tavern', 'tavern crowd chatter', 'Saved sounds/instant/pirate-tavern-croud-instant.mp3', 0.5, 'dnd');
