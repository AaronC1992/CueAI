...
export function buildTriggerMap(savedSounds) {
    ...
    add('siren', 'police siren', 'sounds/police-siren-wail.mp3', 0.75, 'vehicle');
    add('sirens', 'distant sirens', 'sounds/distant-city-siren-ambience.mp3', 0.6, 'vehicle');
    add('police', 'police siren', 'sounds/police-siren-wail.mp3', 0.75, 'vehicle');
    add('cop', 'police siren', 'sounds/police-siren-wail.mp3', 0.75, 'vehicle');
    add('cops', 'police siren', 'sounds/police-siren-wail.mp3', 0.75, 'vehicle');
    add('cruiser', 'police siren', 'sounds/police-siren-wail.mp3', 0.75, 'vehicle');
    add('patrol', 'police siren', 'sounds/police-siren-wail.mp3', 0.7, 'vehicle');
    add('ambulance', 'ambulance siren', 'sounds/ambulance-siren.mp3', 0.75, 'vehicle');
    add('paramedic', 'ambulance siren', 'sounds/ambulance-siren.mp3', 0.75, 'vehicle');
    add('medic', 'ambulance siren', 'sounds/ambulance-siren.mp3', 0.7, 'vehicle');
    add('ems', 'ambulance siren', 'sounds/ambulance-siren.mp3', 0.75, 'vehicle');
    add('firetruck', 'fire truck siren', 'sounds/fire-truck-siren-air-horn.mp3', 0.75, 'vehicle');
    add('firefighter', 'fire truck siren', 'sounds/fire-truck-siren-air-horn.mp3', 0.7, 'vehicle');
    add('raid', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.8, 'vehicle');
    add('airraid', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.8, 'vehicle');
    add('wartime', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.7, 'vehicle');
    add('wwii', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.7, 'vehicle');
    add('blitz', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.75, 'vehicle');
    add('evacuation', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.7, 'vehicle');
    add('klaxon', 'air raid siren', 'sounds/air-raid-siren-warning.mp3', 0.75, 'vehicle');
    add('tornado', 'tornado siren', 'sounds/tornado-civil-defense-siren.mp3', 0.8, 'vehicle');
    add('twister', 'tornado siren', 'sounds/tornado-civil-defense-siren.mp3', 0.75, 'vehicle');
    add('cyclone', 'tornado siren', 'sounds/tornado-civil-defense-siren.mp3', 0.75, 'vehicle');
    add('dispatch', 'police radio', 'sounds/police-radio-dispatch-chatter.mp3', 0.6, 'vehicle');
    add('dispatcher', 'police radio', 'sounds/police-radio-dispatch-chatter.mp3', 0.6, 'vehicle');
    add('squelch', 'police radio', 'sounds/police-radio-dispatch-chatter.mp3', 0.6, 'vehicle');
    add('scanner', 'emergency scanner', 'sounds/emergency-scanner-static.mp3', 0.55, 'vehicle');
    add('honk', 'car horn', 'sounds/car-horn-single-honk.mp3', 0.7, 'vehicle');
    add('honking', 'car horn', 'sounds/car-horn-single-honk.mp3', 0.7, 'vehicle');
    add('beep', 'car horn', 'sounds/car-horn-single-honk.mp3', 0.6, 'vehicle');
    add('doppler', 'emergency pass by', 'sounds/emergency-vehicle-passing-by.mp3', 0.7, 'vehicle');
...
const CONTEXT_REQUIRED = {
    dog: /\b(dog|hound|puppy)\b.{0,40}\b(bark|barks|barked|barking|woof|growl|growls|growled|growling|howl|howls|howled|howling|whimper|whimpering)\b|\b(bark|barks|barked|barking|woof|growl|growls|growled|growling|howl|howls|howled|howling|whimper|whimpering)\b.{0,40}\b(dog|hound|puppy)\b/,
    ...
    bark: /\b(dog|dogs|hound|hounds|puppy)\b.{0,40}\bbark(?:s|ed|ing)?\b|\bbark(?:s|ed|ing)?\b.{0,40}\b(dog|dogs|hound|hounds|puppy)\b/,
    barking: /\b(dog|dogs|hound|hounds|puppy)\b.{0,40}\bbark(?:s|ed|ing)?\b|\bbark(?:s|ed|ing)?\b.{0,40}\b(dog|dogs|hound|hounds|puppy)\b/,
    howl: /\b(wolf|wolves|dog|dogs|hound|hounds|coyote|coyotes)\b.{0,40}\bhowl(?:s|ed|ing)?\b|\bhowl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|hounds|coyote|coyotes)\b/,
    howling: /\b(wolf|wolves|dog|dogs|hound|hounds|coyote|coyotes)\b.{0,40}\bhowl(?:s|ed|ing)?\b|\bhowl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|hounds|coyote|coyotes)\b/,
    growl: /\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b.{0,40}\bgrowl(?:s|ed|ing)?\b|\bgrowl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b/,
    growling: /\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b.{0,40}\bgrowl(?:s|ed|ing)?\b|\bgrowl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b/,
    snarl: /\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b.{0,40}\bsnarl(?:s|ed|ing)?\b|\bsnarl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b/,
    snarling: /\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b.{0,40}\bsnarl(?:s|ed|ing)?\b|\bsnarl(?:s|ed|ing)?\b.{0,40}\b(wolf|wolves|dog|dogs|hound|bear|lion|tiger|dragon|monster|beast|creature|demon|troll|orc|goblin|zombie|werewolf)\b/,
    hiss: /\b(cat|kitten|snake|serpent)\b.{0,40}\bhiss(?:es|ed|ing)?\b|\bhiss(?:es|ed|ing)?\b.{0,40}\b(cat|kitten|snake|serpent)\b/,
    hissing: /\b(cat|kitten|snake|serpent)\b.{0,40}\bhiss(?:es|ed|ing)?\b|\bhiss(?:es|ed|ing)?\b.{0,40}\b(cat|kitten|snake|serpent)\b/,
    screech: /\b(cat|kitten)\b.{0,40}\bscreech(?:es|ed|ing)?\b|\bscreech(?:es|ed|ing)?\b.{0,40}\b(cat|kitten)\b/,
    roar: /\b(lion|tiger|dragon|monster|beast|creature|demon|bear|troll|ogre)\b.{0,40}\broar(?:s|ed|ing)?\b|\broar(?:s|ed|ing)?\b.{0,40}\b(lion|tiger|dragon|monster|beast|creature|demon|bear|troll|ogre)\b/,
    roared: /\b(lion|tiger|dragon|monster|beast|creature|demon|bear|troll|ogre)\b.{0,40}\broar(?:s|ed|ing)?\b|\broar(?:s|ed|ing)?\b.{0,40}\b(lion|tiger|dragon|monster|beast|creature|demon|bear|troll|ogre)\b/,
    ...
    wolf: /\b(wolf|wolves)\b.{0,40}\b(howl|howls|howled|howling|growl|growls|growled|growling|snarl|snarls|snarled|snarling|roar|roars|roared|roaring)\b|\b(howl|howls|howled|howling|growl|growls|growled|growling|snarl|snarls|snarled|snarling|roar|roars|roared|roaring)\b.{0,40}\b(wolf|wolves)\b/,
    wolves: /\b(wolf|wolves)\b.{0,40}\b(howl|howls|howled|howling|growl|growls|growled|growling|snarl|snarls|snarled|snarling|roar|roars|roared|roaring)\b|\b(howl|howls|howled|howling|growl|growls|growled|growling|snarl|snarls|snarled|snarling|roar|roars|roared|roaring)\b.{0,40}\b(wolf|wolves)\b/,
