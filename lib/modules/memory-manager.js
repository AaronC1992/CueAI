...
export class CacheManager {
    constructor() {
        ...
        this._memoryCriticalHandler = null;
    }
    ...
    start() {
        ...
        this._memoryCriticalHandler = () => {
            this.emergencyCleanup();
        };
        window.addEventListener('SuiteRhythm:memory-critical', this._memoryCriticalHandler);
    }
    ...
    stop() {
        ...
        if (this._memoryCriticalHandler) {
            window.removeEventListener('SuiteRhythm:memory-critical', this._memoryCriticalHandler);
            this._memoryCriticalHandler = null;
        }
    }
